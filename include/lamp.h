...
private:
    ...
    void drawSmallDigits(const char *digits, int16_t x, int16_t y, const CRGB &letterColor);
    void drawSmallPixel(int16_t x, int16_t y, const CRGB &letterColor, bool on);
...
public:
    ...
    uint8_t getGlobalBrightness() {return globalBrightness;}    // get Global Brightness value even if GBR is OFF
